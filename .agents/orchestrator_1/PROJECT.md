...
| M1 | Audio Engine & Sarvam AI Pipeline | AudioRecord, WavEncoder, AudioPlayer, Saaras v3, Mayura v1, Bulbul v3 (hi->en) | M0 | IN_PROGRESS | Pipeline interfaces, audio recording, WAV encoding, Sarvam API client |
| M2 | Single-Screen Compose UI & FSM | MainScreen, PTT Button, MainViewModel 7-state FSM, Permissions | M1 | PLANNED | Single screen Compose UI, Hold-to-Speak PTT, 7-state FSM |
